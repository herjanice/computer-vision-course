...
def main():
    ...
    if FEATURE == 'tiny_image':
        # TODO Modify get_tiny_images.py : DONE
        train_image_feats = get_tiny_images(train_image_paths)
        test_image_feats = get_tiny_images(test_image_paths)

    elif FEATURE == 'bag_of_sift':
        # TODO Modify build_vocabulary.py : DONE
        ...
        if os.path.isfile('train_image_feats.pkl') is False:
            # TODO Modify get_bags_of_sifts.py : DONE
    ...
    if CLASSIFIER == 'nearest_neighbor':
        # TODO Modify nearest_neighbor_classify.py : DONE
